...
class EditClient(forms.Form):
    ...
    lat = forms.CharField(label="Latitude", required=True, max_length=20, widget=forms.TextInput(attrs={'placeholder':'Latitude', 'class':'form-control', 'class':'form-control'}))
...
class AddClient(forms.Form):
    ...
    lat = forms.CharField(label="Latitude", required=True, max_length=20, widget=forms.TextInput(attrs={'placeholder':'Latitude', 'class':'form-control'}))
